...
export default function Home() {
  return <main className="portfolio">
    ...
    <section id="about-me" className="about"><h2>about me</h2><p>I’m Benji, a product designer based in NYC with 15 years experience designing for financial services, healthcare, and the insurance industry.</p><p>My work spans user research and design.</p><ol className="skills-list">
